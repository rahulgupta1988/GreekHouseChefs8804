...
public class OutHoseNumbersDetails extends HeaderActivtyCheff {
    ...
    public void initViews()
    {
        ...
        getAllLunchAllergyLists = new LatePlateManagerCheff(OutHoseNumbersDetails.this).getAllLunchAllergyLists();
        Log.i("respo_LunchAllergy_size", "" + getAllLunchAllergyLists.size());
        getAllDinnerAllergyLists = new LatePlateManagerCheff(OutHoseNumbersDetails.this).getAllDinnerAllergyLists();
        ...
        if (getAllLunchAllergyLists.size()>0)
        {
            ...
            allergy_lunch_list.setAdapter(new LatePlateDetailsAdapter(OutHoseNumbersDetails.this, getAllLunchAllergyLists));
        }
        else
        {
        ...
        if (getAllDinnerAllergyLists.size()>0)
        {
            ...
            allergy_dinner_list.setAdapter(new LatePlateDetailsAdapterDinner(OutHoseNumbersDetails.this, getAllDinnerAllergyLists));
        }
        else
        {
...
*/
    ...
    {
        Constant.ListElements_NUMBERS.clear();
        Intent intent=new Intent(OutHoseNumbersDetails.this,OutHouseNumbersActivity.class);
