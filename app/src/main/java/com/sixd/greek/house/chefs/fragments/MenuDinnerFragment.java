...
public class MenuDinnerFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.menudinner_view, container, false);
        ...
        dinner_list.setAdapter(new Menu_BreakfastListAdapter(mContext, 3));
