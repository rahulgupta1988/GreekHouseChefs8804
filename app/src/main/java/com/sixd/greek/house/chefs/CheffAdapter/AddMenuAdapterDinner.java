package com.sixd.greek.house.chefs.CheffAdapter;
    ...
    public class AddMenuAdapterDinner extends BaseAdapter {
        Context mcontext;
        List<String> ElementsArrayListProduct;
        ListView listview;
        String value_check;

        public AddMenuAdapterDinner(Context context, List<String> ListElementsProduct, ListView listView, String value_check)
        {
                ...
                public void onClick(View v)
                {
                    ...
                    if (value_check.equalsIgnoreCase("ed"))
                    {
                        ...
                        try {
                            ...
                            {
                                Constant.ListElementsFinal_temp_dinner.remove(ElementsArrayListProduct.get(pos));
                                listview.setAdapter(new AddMenuAdapterDinner(mcontext, Constant.ListElementsFinal_temp_dinner,listview,value_check));
