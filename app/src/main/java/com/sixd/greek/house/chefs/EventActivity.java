...
public class EventActivity extends HeaderActivty {
    ...
    public void initViews(){
        ...
        allEventses= new EventManager(EventActivity.this).getAllEvents();
        ...
        event_list.setAdapter(new AllEventsAdapter(EventActivity.this, temp_ll_AllEvents));
    ...
    public void onBackPressed() {
        temp_ll_AllEvents.clear();
        Intent intent=new Intent(EventActivity.this,HomeActivityStudent.class);
