package com.sixd.greek.house.chefs.CheffAdapter;
    ...
    public class AddMenuAdapterBreakFast extends BaseAdapter {
        Context mcontext;
        List<String> ElementsArrayListProduct;
        ListView listview;
        String value_check;

        public AddMenuAdapterBreakFast(Context context, List<String> ListElementsProduct, ListView listView, String value_check)
        {
                ...
                public void onClick(View v)
                {
                    ...
                    if (value_check.equalsIgnoreCase("ed"))
                    {
                        ...
                        try {
                            ...
                            {
                                Constant.ListElementsFinal_temp.remove(ElementsArrayListProduct.get(pos));
                                listview.setAdapter(new AddMenuAdapterBreakFast(mcontext, Constant.ListElementsFinal_temp,listview,value_check));
