...
import com.sixd.greek.house.chefs.CheffAdapter.AddMenuAdapterLunch;
...
public class AddMenuCheffActivityLunch extends HeaderActivtyCheff {
   ...
   /* SearchItemAdapter searchItemAdapter;*/
    ...
    public void initViews()
    {
       ...
       /* temp_ll_MenuItemDishes=new ArrayList<GetMasterAllMenuItems>();*/
        ...
        {
            add_menu_day_txt.setText("Lunch - Sunday "+"("+date_value+")");
        }
        else if (day_val.equalsIgnoreCase("2"))
        {
            add_menu_day_txt.setText("Lunch - Monday "+"("+date_value+")");
        }
        else if (day_val.equalsIgnoreCase("3"))
        {
            add_menu_day_txt.setText("Lunch - Tuesday "+"("+date_value+")");
        }
        else if (day_val.equalsIgnoreCase("4"))
        {
            add_menu_day_txt.setText("Lunch - Wednesday "+"("+date_value+")");
        }
        else if (day_val.equalsIgnoreCase("5"))
        {
            add_menu_day_txt.setText("Lunch - Thursday "+"("+date_value+")");
        }
        else if (day_val.equalsIgnoreCase("6"))
        {
            add_menu_day_txt.setText("Lunch - Friday "+"("+date_value+")");
        }
        else if (day_val.equalsIgnoreCase("7"))
        {
            add_menu_day_txt.setText("Lunch - Saturday "+"("+date_value+")");
        }
       ...
       /* searchItems = new MenuCalendarManager(AddMenuCheffActivityLunch.this).getMasterAllMenuItemses();
        ...
        if (value_check.equalsIgnoreCase("ed"))
        {
            ...
            try
            {
                ...
                {
                    if (Constant.ListElementsFinal_temp_lunch.size() == 1)
                    {
                        if (Constant.ListElementsFinal_temp_lunch.get(0) != null
                                && !Constant.ListElementsFinal_temp_lunch.get(0).equalsIgnoreCase("")
                                && !Constant.ListElementsFinal_temp_lunch.get(0).equalsIgnoreCase("null")
                                && !Constant.ListElementsFinal_temp_lunch.get(0).equalsIgnoreCase(" "))
                        {
                            add_menu_list.setAdapter(new AddMenuAdapterLunch(mContext,Constant.ListElementsFinal_temp_lunch,add_menu_list,value_check));
                        }
                    }
                    else
                    {
        ...
        add_menu_txt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                if (!menu_ed_txt.getText().toString().trim().equalsIgnoreCase("")) {
                    ...
                    if (value_check.equalsIgnoreCase("ed"))
                    {
                        Log.i("respo_ed_size_before", "" + Constant.ListElementsFinal_temp_lunch.size());
                        try {
                            ...
                            if (Constant.ListElementsFinal_temp_lunch.size() == 1)
                            {
                                if (Constant.ListElementsFinal_temp_lunch.get(0) != null
                                        ...
                                        && !Constant.ListElementsFinal_temp_lunch.get(0).equalsIgnoreCase(" "))
                                {
                                    Constant.ListElementsFinal_temp_lunch.add(menu_title);
                                    Log.i("respo_ed_size_after1", "" + Constant.ListElementsFinal_temp_lunch.size());
                                    add_menu_list.setAdapter(new AddMenuAdapterLunch(mContext, Constant.ListElementsFinal_temp_lunch, add_menu_list, value_check));
                                    menu_ed_txt.setText("");
                                }
                                else
                                {
                                    ...
                                    Constant.ListElementsFinal_temp_lunch.add(menu_title);
                                    Log.i("respo_ed_size_after2", "" + Constant.ListElementsFinal_temp_lunch.size());
                                    add_menu_list.setAdapter(new AddMenuAdapterLunch(mContext, Constant.ListElementsFinal_temp_lunch, add_menu_list, value_check));
                                    menu_ed_txt.setText("");
                                }
                            }
                            ...
                            {
                                Constant.ListElementsFinal_temp_lunch.add(menu_title);
                                Log.i("respo_ed_size_after3", "" + Constant.ListElementsFinal_temp_lunch.size());
                                add_menu_list.setAdapter(new AddMenuAdapterLunch(mContext,Constant.ListElementsFinal_temp_lunch,add_menu_list,value_check));
                                menu_ed_txt.setText("");
                            }
                        }
                    ...
                    {
                        Log.i("respo_ed2_size_before", "" + Constant.ListElementsFinal_temp_lunch.size());
                        try {
                            ...
                            if (Constant.ListElementsFinal_temp_lunch.size() == 1)
                            {
                                ...
                                {
                                    Constant.ListElementsFinal_temp_lunch.add(menu_title);
                                    Log.i("respo_ed2_size_after1", "" + Constant.ListElementsFinal_temp_lunch.size());
                                    add_menu_list.setAdapter(new AddMenuAdapterLunch(mContext, Constant.ListElementsFinal_temp_lunch, add_menu_list, value_check));
                                    menu_ed_txt.setText("");
                                }
                                else
                                {
                                    Constant.ListElementsFinal_temp_lunch.clear();
                                    Constant.ListElementsFinal_temp_lunch.add(menu_title);
                                    Log.i("respo_ed2_size_after2", "" + Constant.ListElementsFinal_temp_lunch.size());
                                    add_menu_list.setAdapter(new AddMenuAdapterLunch(mContext, Constant.ListElementsFinal_temp_lunch, add_menu_list, value_check));
                                    menu_ed_txt.setText("");
                                }
                            }
                            ...
                            {
                                Constant.ListElementsFinal_temp_lunch.add(menu_title);
                                Log.i("respo_ed2_size_after3", "" + Constant.ListElementsFinal_temp_lunch.size());
                                add_menu_list.setAdapter(new AddMenuAdapterLunch(mContext,Constant.ListElementsFinal_temp_lunch,add_menu_list,value_check));
                                menu_ed_txt.setText("");
                            }
                        }
                    ...
                    {
                        Log.i("respo_ed3_size_before", "" + Constant.ListElementsFinal_temp_lunch.size());
                        try {
                            ...
                            if (Constant.ListElementsFinal_temp_lunch.size() == 1)
                            {
                                ...
                                {
                                    Constant.ListElementsFinal_temp_lunch.add(menu_title);
                                    Log.i("respo_ed3_size_after1", "" + Constant.ListElementsFinal_temp_lunch.size());
                                    add_menu_list.setAdapter(new AddMenuAdapterLunch(mContext, Constant.ListElementsFinal_temp_lunch, add_menu_list, value_check));
                                    menu_ed_txt.setText("");
                                }
                                else
                                {
                                    Constant.ListElementsFinal_temp_lunch.clear();
                                    Constant.ListElementsFinal_temp_lunch.add(menu_title);
                                    Log.i("respo_ed3_size_after2", "" + Constant.ListElementsFinal_temp_lunch.size());
                                    add_menu_list.setAdapter(new AddMenuAdapterLunch(mContext, Constant.ListElementsFinal_temp_lunch, add_menu_list, value_check));
                                    menu_ed_txt.setText("");
                                }
                            }
                            ...
                            {
                                Constant.ListElementsFinal_temp_lunch.add(menu_title);
                                Log.i("respo_ed3_size_after3", "" + Constant.ListElementsFinal_temp_lunch.size());
                                add_menu_list.setAdapter(new AddMenuAdapterLunch(mContext,Constant.ListElementsFinal_temp_lunch,add_menu_list,value_check));
                                menu_ed_txt.setText("");
                            }
                        }
                    ...
                    {
                        Log.i("respo_ed4_size_before", "" + Constant.ListElementsFinal_temp_lunch.size());
                        try {
                            ...
                            if (Constant.ListElementsFinal_temp_lunch.size() == 1)
                            {
                                ...
                                {
                                    Constant.ListElementsFinal_temp_lunch.add(menu_title);
                                    Log.i("respo_ed4_size_after1", "" + Constant.ListElementsFinal_temp_lunch.size());
                                    add_menu_list.setAdapter(new AddMenuAdapterLunch(mContext, Constant.ListElementsFinal_temp_lunch, add_menu_list, value_check));
                                    menu_ed_txt.setText("");
                                }
                                else
                                {
                                    Constant.ListElementsFinal_temp_lunch.clear();
                                    Constant.ListElementsFinal_temp_lunch.add(menu_title);
                                    Log.i("respo_ed4_size_after2", "" + Constant.ListElementsFinal_temp_lunch.size());
                                    add_menu_list.setAdapter(new AddMenuAdapterLunch(mContext, Constant.ListElementsFinal_temp_lunch, add_menu_list, value_check));
                                    menu_ed_txt.setText("");
                                }
                            }
                            ...
                            {
                                Constant.ListElementsFinal_temp_lunch.add(menu_title);
                                Log.i("respo_ed4_size_after3", "" + Constant.ListElementsFinal_temp_lunch.size());
                                add_menu_list.setAdapter(new AddMenuAdapterLunch(mContext,Constant.ListElementsFinal_temp_lunch,add_menu_list,value_check));
                                menu_ed_txt.setText("");
                            }
                    ...
                    {
                        Log.i("respo_ed5_size_before", "" + Constant.ListElementsFinal_temp_lunch.size());
                        try {
                            ...
                            if (Constant.ListElementsFinal_temp_lunch.size() == 1)
                            {
                                ...
                                {
                                    Constant.ListElementsFinal_temp_lunch.add(menu_title);
                                    Log.i("respo_ed5_size_after1", "" + Constant.ListElementsFinal_temp_lunch.size());
                                    add_menu_list.setAdapter(new AddMenuAdapterLunch(mContext, Constant.ListElementsFinal_temp_lunch, add_menu_list, value_check));
                                    menu_ed_txt.setText("");
                                }
                                else
                                {
                                    Constant.ListElementsFinal_temp_lunch.clear();
                                    Constant.ListElementsFinal_temp_lunch.add(menu_title);
                                    Log.i("respo_ed5_size_after2", "" + Constant.ListElementsFinal_temp_lunch.size());
                                    add_menu_list.setAdapter(new AddMenuAdapterLunch(mContext, Constant.ListElementsFinal_temp_lunch, add_menu_list, value_check));
                                    menu_ed_txt.setText("");
                                }
                            }
                            ...
                            {
                                Constant.ListElementsFinal_temp_lunch.add(menu_title);
                                Log.i("respo_ed5_size_after3", "" + Constant.ListElementsFinal_temp_lunch.size());
                                add_menu_list.setAdapter(new AddMenuAdapterLunch(mContext,Constant.ListElementsFinal_temp_lunch,add_menu_list,value_check));
                                menu_ed_txt.setText("");
                            }
                    ...
                    {
                        Log.i("respo_ed6_size_before", "" + Constant.ListElementsFinal_temp_lunch.size());
                        try {
                            ...
                            if (Constant.ListElementsFinal_temp_lunch.size() == 1)
                            {
                                ...
                                {
                                    Constant.ListElementsFinal_temp_lunch.add(menu_title);
                                    Log.i("respo_ed6_size_after1", "" + Constant.ListElementsFinal_temp_lunch.size());
                                    add_menu_list.setAdapter(new AddMenuAdapterLunch(mContext, Constant.ListElementsFinal_temp_lunch, add_menu_list, value_check));
                                    menu_ed_txt.setText("");
                                }
                                else
                                {
                                    Constant.ListElementsFinal_temp_lunch.clear();
                                    Constant.ListElementsFinal_temp_lunch.add(menu_title);
                                    Log.i("respo_ed6_size_after2", "" + Constant.ListElementsFinal_temp_lunch.size());
                                    add_menu_list.setAdapter(new AddMenuAdapterLunch(mContext, Constant.ListElementsFinal_temp_lunch, add_menu_list, value_check));
                                    menu_ed_txt.setText("");
                                }
                            }
                            ...
                            {
                                Constant.ListElementsFinal_temp_lunch.add(menu_title);
                                Log.i("respo_ed6_size_after3", "" + Constant.ListElementsFinal_temp_lunch.size());
                                add_menu_list.setAdapter(new AddMenuAdapterLunch(mContext,Constant.ListElementsFinal_temp_lunch,add_menu_list,value_check));
                                menu_ed_txt.setText("");
                            }
                    ...
                    {
                        Log.i("respo_ed7_size_before", ""+Constant.ListElementsFinal_temp_lunch.size());
                        try {
                            ...
                            if (Constant.ListElementsFinal_temp_lunch.size() == 1)
                            {
                                ...
                                {
                                    Constant.ListElementsFinal_temp_lunch.add(menu_title);
                                    Log.i("respo_ed7_size_after1", "" + Constant.ListElementsFinal_temp_lunch.size());
                                    add_menu_list.setAdapter(new AddMenuAdapterLunch(mContext,Constant.ListElementsFinal_temp_lunch,add_menu_list,value_check));
                                    menu_ed_txt.setText("");
                                }
                                else
                                {
                                    Constant.ListElementsFinal_temp_lunch.clear();
                                    Constant.ListElementsFinal_temp_lunch.add(menu_title);
                                    Log.i("respo_ed7_size_after2", "" + Constant.ListElementsFinal_temp_lunch.size());
                                    add_menu_list.setAdapter(new AddMenuAdapterLunch(mContext, Constant.ListElementsFinal_temp_lunch, add_menu_list, value_check));
                                    menu_ed_txt.setText("");
                                }
                            }
                            ...
                            {
                                Constant.ListElementsFinal_temp_lunch.add(menu_title);
                                Log.i("respo_ed7_size_after3", "" + Constant.ListElementsFinal_temp_lunch.size());
                                add_menu_list.setAdapter(new AddMenuAdapterLunch(mContext,Constant.ListElementsFinal_temp_lunch,add_menu_list,value_check));
                                menu_ed_txt.setText("");
                            }
                        }
            ...
            public void onClick(View v) {
               /* if (Constant.ListElementsMenutitle.size() != 0)
                ...
                if (value_check.equalsIgnoreCase("ed")) {
                    ...
                    try {
                        if (Constant.ListElementsFinal_temp_lunch.size() != 0) {
                            Log.i("respo_ed_size_submit", "" + Constant.ListElementsFinal_temp_lunch.size());
                            Constant.ListElementsMenutitle_lunch.clear();
                            for (int i = 0; i < Constant.ListElementsFinal_temp_lunch.size(); i++) {
                                Constant.ListElementsMenutitle_lunch.add(Constant.ListElementsFinal_temp_lunch.get(i));
                            }
                            Constant.ListElementsFinal_temp_lunch.clear();
                            Intent intent = new Intent(AddMenuCheffActivityLunch.this, MenuActivityCheff.class);
                    ...
                    try {
                        if (Constant.ListElementsFinal_temp_lunch.size() != 0) {
                            Log.i("respo_ed2_size_submit", "" + Constant.ListElementsFinal_temp_lunch.size());
                            Constant.ListElementsMenutitle2_lunch.clear();
                            for (int i = 0; i < Constant.ListElementsFinal_temp_lunch.size(); i++) {
                                Constant.ListElementsMenutitle2_lunch.add(Constant.ListElementsFinal_temp_lunch.get(i));
                            }
                            Constant.ListElementsFinal_temp_lunch.clear();
                            Intent intent = new Intent(AddMenuCheffActivityLunch.this, MenuActivityCheff.class);
                            intent.putExtra("tabposition","1");
                    ...
                    try {
                        if (Constant.ListElementsFinal_temp_lunch.size() != 0) {
                            Log.i("respo_ed3_size_submit", "" + Constant.ListElementsFinal_temp_lunch.size());
                            Constant.ListElementsMenutitle3_lunch.clear();
                            for (int i = 0; i < Constant.ListElementsFinal_temp_lunch.size(); i++) {
                                Constant.ListElementsMenutitle3_lunch.add(Constant.ListElementsFinal_temp_lunch.get(i));
                            }
                            Constant.ListElementsFinal_temp_lunch.clear();
                            Intent intent = new Intent(AddMenuCheffActivityLunch.this, MenuActivityCheff.class);
                            intent.putExtra("tabposition","1");
                    ...
                    try {
                        if (Constant.ListElementsFinal_temp_lunch.size() != 0) {
                            Log.i("respo_ed4_size_submit", "" + Constant.ListElementsFinal_temp_lunch.size());
                            Constant.ListElementsMenutitle4_lunch.clear();
                            for (int i = 0; i < Constant.ListElementsFinal_temp_lunch.size(); i++) {
                                Constant.ListElementsMenutitle4_lunch.add(Constant.ListElementsFinal_temp_lunch.get(i));
                            }
                            Constant.ListElementsFinal_temp_lunch.clear();
                            Intent intent = new Intent(AddMenuCheffActivityLunch.this, MenuActivityCheff.class);
                            intent.putExtra("tabposition","1");
                    ...
                    try {
                        if (Constant.ListElementsFinal_temp_lunch.size() != 0) {
                            Log.i("respo_ed5_size_submit", "" + Constant.ListElementsFinal_temp_lunch.size());
                            Constant.ListElementsMenutitle5_lunch.clear();
                            for (int i = 0; i < Constant.ListElementsFinal_temp_lunch.size(); i++) {
                                Constant.ListElementsMenutitle5_lunch.add(Constant.ListElementsFinal_temp_lunch.get(i));
                            }
                            Constant.ListElementsFinal_temp_lunch.clear();
                            Intent intent = new Intent(AddMenuCheffActivityLunch.this, MenuActivityCheff.class);
                            intent.putExtra("tabposition","1");
                    ...
                    Log.i("respo_ed6_size_submit", "" + Constant.ListElementsFinal_temp_lunch.size());
                    try {
                        if (Constant.ListElementsFinal_temp_lunch.size() != 0) {
                            Log.i("respo_ed6_size_submit", "" + Constant.ListElementsFinal_temp_lunch.size());
                            Constant.ListElementsMenutitle6_lunch.clear();
                            for (int i = 0; i < Constant.ListElementsFinal_temp_lunch.size(); i++) {
                                Constant.ListElementsMenutitle6_lunch.add(Constant.ListElementsFinal_temp_lunch.get(i));
                            }
                            Constant.ListElementsFinal_temp_lunch.clear();
                            Intent intent = new Intent(AddMenuCheffActivityLunch.this, MenuActivityCheff.class);
                            intent.putExtra("tabposition","1");
                    ...
                    Log.i("respo_ed7_size_submit", "" + Constant.ListElementsFinal_temp_lunch.size());
                    try {
                        if (Constant.ListElementsFinal_temp_lunch.size() != 0) {
                            Log.i("respo_ed7_size_submit", "" + Constant.ListElementsFinal_temp_lunch.size());
                            Constant.ListElementsMenutitle7_lunch.clear();
                            for (int i = 0; i < Constant.ListElementsFinal_temp_lunch.size(); i++) {
                                Constant.ListElementsMenutitle7_lunch.add(Constant.ListElementsFinal_temp_lunch.get(i));
                            }
                            Constant.ListElementsFinal_temp_lunch.clear();
                            Intent intent = new Intent(AddMenuCheffActivityLunch.this, MenuActivityCheff.class);
                            intent.putExtra("tabposition","1");
