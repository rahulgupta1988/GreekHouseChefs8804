...
public class LatePlateRequestActivity extends HeaderActivty implements View.OnClickListener{

    TextView headr_outhouse;
    ...
    String week_type="",request_type="",spinner_item_val="",current_week_array="",next_week_array="",request_date ="",student_type ="in_house";
    LinearLayout linear;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setHeaderTitele("Late Plate Request");

        linear=(LinearLayout)findViewById(R.id.linear);
        headr_outhouse = (TextView)findViewById(R.id.headr_outhouse);
        String simple = "Please select next week option from drop down in case you want to submit request for the entire semester.";
        String colored = "*";
    ...
    public void initViews()
    {
      ...
      /*  week_sel=(Spinner)findViewById(R.id.week_sel);
        ...
        week_sel.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener()
        {
            ...
            {
                getCurrentWeekLunches = new LatePlateManagerCheff(LatePlateRequestActivity.this).
                        getCurrentWeekLunchList();
                getCurrentWeekDinners = new LatePlateManagerCheff(LatePlateRequestActivity.this).
                        getCurrentWeekDinnersList();
                getNextWeekLunches = new LatePlateManagerCheff(LatePlateRequestActivity.this).
                        getNextWeekLunchList();
                getNextWeekDinners = new LatePlateManagerCheff(LatePlateRequestActivity.this).
                ...
                try {
                    ...
                    if (spinner_item_val.equalsIgnoreCase("Current week"))
                    {
                        ...
                        if (getCurrentWeekLunches.get(1).getRequest_date().toString().trim().equalsIgnoreCase(days[1].toString().trim()))
                        {
                            ...
                            Log.i("respo_lunch_tue",""+ischecked_val);
                            if(ischecked_val.equalsIgnoreCase("0"))
                            {
                                ch2.setSelected(false);
                            }
                        ...
                        if (getCurrentWeekLunches.get(2).getRequest_date().toString().trim().equalsIgnoreCase(days[2].toString().trim()))
                        {
                            ...
                            Log.i("respo_lunch_wed",""+ischecked_val);
                            if(ischecked_val.equalsIgnoreCase("0"))
                            {
                                ch3.setSelected(false);
                            }
                        ...
                        if (getCurrentWeekLunches.get(3).getRequest_date().toString().trim().equalsIgnoreCase(days[3].toString().trim()))
                        {
                            ...
                            Log.i("respo_lunch_thu",""+ischecked_val);
                            if(ischecked_val.equalsIgnoreCase("0"))
                            {
                                ch4.setSelected(false);
                            }
                        ...
                        if (getCurrentWeekLunches.get(4).getRequest_date().toString().trim().equalsIgnoreCase(days[4].toString().trim()))
                        {
                            ...
                            Log.i("respo_lunch_fri",""+ischecked_val);
                            if(ischecked_val.equalsIgnoreCase("0"))
                            {
                                ch5.setSelected(false);
                            }
                        ...
                        if (getCurrentWeekLunches.get(5).getRequest_date().toString().trim().equalsIgnoreCase(days[5].toString().trim()))
                        {
                            ...
                            Log.i("respo_lunch_sat",""+ischecked_val);
                            if(ischecked_val.equalsIgnoreCase("0"))
                            {
                                ch6.setSelected(false);
                            }
                        ...
                        if (getCurrentWeekLunches.get(6).getRequest_date().toString().trim().equalsIgnoreCase(days[6].toString().trim()))
                        {
                            ...
                            Log.i("respo_lunch_sun",""+ischecked_val);
                            if(ischecked_val.equalsIgnoreCase("0"))
                            {
                                ch7.setSelected(false);
                            }
                ...
                if (spinner_item_val.equalsIgnoreCase("Current week"))
                {
                    /*if(ch1.isSelected()){
                        try {
                            ...
                            {
                                Toast.makeText(LatePlateRequestActivity.this,"Sorry today lunch is over!",Toast.LENGTH_LONG).show();
                            }
                            else
                            {
                                if(date1.compareTo(date2)>=0 ){
                                    Toast.makeText(LatePlateRequestActivity.this,"Sorry old date is over!",Toast.LENGTH_LONG).show();
                                }
                                else {
                                    ch1.setSelected(false);
                        ...
                        try {
                            //Toast.makeText(LatePlateRequestActivity.this,"hiunselected",Toast.LENGTH_LONG).show();
                            ...
                            if(date1.compareTo(date2)==0){
                                ...
                                Toast.makeText(LatePlateRequestActivity.this,"Sorry lunch is over for this date!",Toast.LENGTH_LONG).show();
                                ...
                                if (date1.compareTo(date2)<=0)
                                {
                                    ...
                                    Toast.makeText(LatePlateRequestActivity.this,"Sorry date is over!",Toast.LENGTH_LONG).show();
                                }
                                ...
                                if (str1.equalsIgnoreCase(str2))
                                {
                                    if (date1.compareTo(date2)<=0 )
                                    {
                                        if(timeString.equalsIgnoreCase("1AM")||timeString.equalsIgnoreCase("2AM")||timeString.equalsIgnoreCase("3AM")
                                                ...
                                                ||timeString.equalsIgnoreCase("7AM")||timeString.equalsIgnoreCase("12AM (Midnight)") )
                                        {
                        ...
                        if(ch4.isSelected())
                        {
                            try {
                                ...
                                if (str1.equalsIgnoreCase(str2))
                                {
                                    if (date1.compareTo(date2)<=0)
                                    {
                                       // Toast.makeText(LatePlateRequestActivity.this,"timeString11="+timeString,Toast.LENGTH_LONG).show();
                            ...
                            try {
                                ...
                                if(str1.equalsIgnoreCase(str2))
                                {
                                    if (date1.compareTo(date2)<=0)
                                    {
                                       // Toast.makeText(LatePlateRequestActivity.this,"timeString21="+timeString,Toast.LENGTH_LONG).show();
                        ...
                        try {
                            ...
                            if (str1.equalsIgnoreCase(str2))
                            {
                                if (date1.compareTo(date2)<=0 )
                                {
                                    if(timeString.equalsIgnoreCase("1AM")||timeString.equalsIgnoreCase("2AM")||timeString.equalsIgnoreCase("3AM")
                                            ||timeString.equalsIgnoreCase("4AM") ||timeString.equalsIgnoreCase("5AM") ||timeString.equalsIgnoreCase("6AM")
                                            ||timeString.equalsIgnoreCase("7AM")||timeString.equalsIgnoreCase("8AM")
                                            ||timeString.equalsIgnoreCase("9AM")||timeString.equalsIgnoreCase("10AM")
                                            ||timeString.equalsIgnoreCase("11AM")||timeString.equalsIgnoreCase("12PM (Noon)")
                                            ||timeString.equalsIgnoreCase("12AM (Midnight)") )
                                    {
                                        ...
                                        Toast.makeText(LatePlateRequestActivity.this,"Sorry dinner is over for this date!",Toast.LENGTH_LONG).show();
                                    }
  ...
  /*   ================make array==================*/
        ...
        if (spinner_item_val.equalsIgnoreCase("Current week"))
        {
                    ...
                    new LatePlateManager(mContext).initaddLatePlateAPI(week_type,student_type,request_type,request_date, new CallBackManager() {
                        ...
                        public void onSuccess(String responce)
                        {
                            ...
                            if(responce.equals("100"))
                            {
                                ...
                                Intent intent=new Intent(LatePlateRequestActivity.this,HomeActivityStudent.class);
           ...
           /* else
            {
                Toast.makeText(LatePlateRequestActivity.this,"Please select lunch or dinner atleast one",Toast.LENGTH_LONG).show();
            }*/
        }
        else
        {
...
*/
    ...
    {
        String Is_outhouse_lateplate="in_house";
            ...
            new LatePlateManagerCheff(mContext).initLateplateDetailsForInhouseAndOutHouseAPI(Is_outhouse_lateplate,
                    new CallBackManager() {
                        ...
                        public void onSuccess(String responce)
                        {
                            ...
                            Log.i("repo_ram_respo",""+responce);

                            if (responce.equals("100"))
                            {
                                Log.i("repo_if_ram_respo",""+responce);

                                getCurrentWeekLunches = new LatePlateManagerCheff(LatePlateRequestActivity.this).getCurrentWeekLunchList();
                                getCurrentWeekDinners = new LatePlateManagerCheff(LatePlateRequestActivity.this).getCurrentWeekDinnersList();
                                getNextWeekLunches = new LatePlateManagerCheff(LatePlateRequestActivity.this).getNextWeekLunchList();
                                getNextWeekDinners = new LatePlateManagerCheff(LatePlateRequestActivity.this).getNextWeekDinnerList();
                            ...
                            {
                                Log.i("repo_else_ram_respo", "" + responce);

                                Snackbar snackbar = Snackbar
                                        .make(linear,responce.toString(), Snackbar.LENGTH_LONG)
                                        .setAction("RETRY", new View.OnClickListener() {
                                            @Override
                                            public void onClick(View view) {
                                            }
                                ...
                                if(responce.contains("Received data"))
                                {
                                    ...
                                    String error_content=""+ Constant.BASEURL + "&param=" +
                                            Constant.API.LATE_OUT_INFO_API+ "&Is_outhouse_lateplate=in_house"
