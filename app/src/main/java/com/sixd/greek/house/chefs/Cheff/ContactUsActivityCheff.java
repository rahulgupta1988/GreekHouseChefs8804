...
public class ContactUsActivityCheff extends HeaderActivtyCheff {
                            ...
                            connec.getNetworkInfo(1).getState() == android.net.NetworkInfo.State.CONNECTED)
                    {
                        ...
                        new ContactUsManager(mContext).initcontactUSAPI(contactus_txt, new CallBackManager() {
                            ...
                            public void onSuccess(String responce)
                            {
                                ...
                                {
                                    //Toast.makeText(mContext, "Your message has been sent to the administrator!", Toast.LENGTH_SHORT).show();
                                    ...
                                    Intent intent = new Intent(ContactUsActivityCheff.this, HomeActivityCheff.class);
