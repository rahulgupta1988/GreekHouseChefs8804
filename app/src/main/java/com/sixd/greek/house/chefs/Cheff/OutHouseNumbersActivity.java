...
public class OutHouseNumbersActivity extends HeaderActivtyCheff {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setHeaderTitele("Out Of House Numbers");
        initViews();
    }
    ...
    public void initViews()
    {
        ...
        allLatePlateChefLists = new LatePlateManagerCheff(OutHouseNumbersActivity.this).getAllLatePlateChefLists();
        Log.i("respo_LatePlatChef_size", "" + allLatePlateChefLists.size());
        getStudenNameLunch=new LatePlateManagerCheff(OutHouseNumbersActivity.this).getStudenNameLunch();
        getStudenNameDinners=new LatePlateManagerCheff(OutHouseNumbersActivity.this).getStudenNameDinners();
    ...
    public void onBackPressed() {
        Intent intent=new Intent(OutHouseNumbersActivity.this,HomeActivityCheff.class);
    ...
    {
        String param="GetallergyForlatePlateOutOfMeal";
            ...
            new LatePlateManagerCheff(mContext).initGetlatePlateAPIDetails(param,Date, new CallBackManager() {
                ...
                public void onSuccess(String responce) {
                    ...
                    if (responce.equals("100")) {
                        ...
                        getAllLunchAllergyLists = new LatePlateManagerCheff(OutHouseNumbersActivity.this).getAllLunchAllergyLists();
                        Log.i("respo_LunchAllergy_size", "" + getAllLunchAllergyLists.size());

                        List<AllDinnerAllergyList> getAllDinnerAllergyLists;
                        getAllDinnerAllergyLists = new LatePlateManagerCheff(OutHouseNumbersActivity.this).getAllDinnerAllergyLists();
                        ...
                        if (getAllLunchAllergyLists.size()==0&&getAllDinnerAllergyLists.size()==0)
                        {
                            Snackbar snackbar = Snackbar
                                    .make(linear, "Out house allergy is not available!", Snackbar.LENGTH_LONG)
                        ...
                        {
                            Intent rate_intent = new Intent(mContext, OutHoseNumbersDetails.class);
