...
public class OutHouseManager {
    String responseStr="";
    Context context;

    public OutHouseManager(Context context){
        this.context=context;
    }

    public void initaddOutHouseAPI(String student_type ,String request_type ,String request_date,final CallBackManager callBackManager){
        ...
        Log.i("responstring", "addLatePlateRequest serviceUrl-->" + Constant.BASEURL + "&param=" +
                Constant.API.ADDMSG_LATE_PLATE_API
