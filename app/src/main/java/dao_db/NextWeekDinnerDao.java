...
/** 
 * DAO for table "NEXT_WEEK_DINNER".
*/
public class NextWeekDinnerDao extends AbstractDao<NextWeekDinner, Void> {

    public static final String TABLENAME = "NEXT_WEEK_DINNER";

    /**
     * Properties of entity NextWeekDinner.<br/>
    ...
    public NextWeekDinnerDao(DaoConfig config) {
        super(config);
    }
    
    public NextWeekDinnerDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"NEXT_WEEK_DINNER\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"NEXT_WEEK_DINNER\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, NextWeekDinner entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, NextWeekDinner entity) {
        stmt.clearBindings();
    ...
    @Override
    public NextWeekDinner readEntity(Cursor cursor, int offset) {
        NextWeekDinner entity = new NextWeekDinner( //
    ...
    @Override
    public void readEntity(Cursor cursor, NextWeekDinner entity, int offset) {
    ...
    @Override
    protected final Void updateKeyAfterInsert(NextWeekDinner entity, long rowId) {
        // Unsupported or missing PK type
        return null;
    }
    
    @Override
    public Void getKey(NextWeekDinner entity) {
        return null;
    }

    @Override
    public boolean hasKey(NextWeekDinner entity) {
        // TODO
        return false;
    }
