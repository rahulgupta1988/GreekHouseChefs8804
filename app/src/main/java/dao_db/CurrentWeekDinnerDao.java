...
/** 
 * DAO for table "CURRENT_WEEK_DINNER".
*/
public class CurrentWeekDinnerDao extends AbstractDao<CurrentWeekDinner, Void> {

    public static final String TABLENAME = "CURRENT_WEEK_DINNER";

    /**
     * Properties of entity CurrentWeekDinner.<br/>
    ...
    public CurrentWeekDinnerDao(DaoConfig config) {
        super(config);
    }
    
    public CurrentWeekDinnerDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"CURRENT_WEEK_DINNER\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"CURRENT_WEEK_DINNER\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, CurrentWeekDinner entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, CurrentWeekDinner entity) {
        stmt.clearBindings();
    ...
    @Override
    public CurrentWeekDinner readEntity(Cursor cursor, int offset) {
        CurrentWeekDinner entity = new CurrentWeekDinner( //
    ...
    @Override
    public void readEntity(Cursor cursor, CurrentWeekDinner entity, int offset) {
    ...
    @Override
    protected final Void updateKeyAfterInsert(CurrentWeekDinner entity, long rowId) {
        // Unsupported or missing PK type
        return null;
    }
    
    @Override
    public Void getKey(CurrentWeekDinner entity) {
        return null;
    }

    @Override
    public boolean hasKey(CurrentWeekDinner entity) {
        // TODO
        return false;
    }
